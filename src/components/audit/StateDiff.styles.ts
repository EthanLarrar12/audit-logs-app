...
export const styles = makeStyles((t) => ({
  ...
  objectContainer:
    "font-sans text-xs bg-slate-50 rounded p-2 border border-slate-200 overflow-auto",
  ...
  section: "space-y-1",
  sectionTitle:
    "font-semibold text-slate-500 uppercase tracking-wider text-[10px]",
  ...
  nestedLine: "border-l-2 border-slate-200 ml-4 pl-4",
