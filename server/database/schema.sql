...
CREATE TYPE history.history_actions AS ENUM (
    'MANDAT_USER_CREATED', 'MANDAT_USER_DELETED', 'MANDAT_USER_SYNCED', 'MANDAT_USER_PROFILE_DG_PARAMS_ADDED', 'MANDAT_USER_PROFILE_DG_PARAMS_REMOVED',
...
CREATE TYPE history.mirage_object_types AS ENUM ('USER', 'ENTITY', 'SHOS', 'DYNAMIC_TAG', 'END_SYSTEM', 'PROFILE', 'DISTRIBUTION_GROUP', 'PARAMETER', 'SYSTEM');
...
CREATE TABLE history.records(
    ...
    history_action history.history_actions NOT NULL,
    executor_id TEXT,
    executor_name TEXT,
