...
INSERT INTO history.records (action_id, updated_time, executor, executor_name, target, target_name, resource, resource_name, target_type, midur_action, resource_type) VALUES
