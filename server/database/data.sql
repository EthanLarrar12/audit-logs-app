...
INSERT INTO history.records (action_id, updated_time, executor, target, resource, target_type, midur_action, resource_type) VALUES
    ('act_001', 1709280000000, 'admin_user', 'john.doe', NULL, 'USER', 'USER_CREATION', NULL),
    ('act_002', 1709283600000, 'editor_user', 'Entity 1', NULL, 'ENTITY', 'ENTITY_EDIT', NULL),
    ('act_003', 1709287200000, 'system_service', 'Shos 123', 'shos_123', 'SHOS', 'SHOS_CREATION', 'SHOS'),
    ('act_004', 1709290800000, 'manager_user', 'Tag A', NULL, 'DYNAMIC_TAG', 'DYNAMIC_TAG_EDIT', NULL),
    ('act_005', 1709294400000, 'admin_user', 'All Users Group', NULL, 'DISTRIBUTION_GROUP', 'DISTRIBUTION_GROUP_CREATION', NULL),
    ('act_006', 1709298000000, 'super_admin', 'jane.smith', NULL, 'USER', 'USER_DELETION', NULL),
    ('act_007', 1709301600000, 'group_admin', 'Distribution List A', 'john.doe', 'DISTRIBUTION_GROUP', 'ADD_USER_TO_DISTRIBUTION_GROUP', 'USER'),
    ('act_008', 1709305200000, 'admin_user', 'Admin Profile', NULL, 'PROFILE', 'PROFILE_CREATION', NULL),
    ('act_009', 1709308800000, 'sys_admin', 'Legacy System', NULL, 'END_SYSTEM', 'END_SYSTEM_DELETION', NULL),
    ('act_010', 1709312400000, 'auto_bot', 'Entity 999', NULL, 'ENTITY', 'ENTITY_CREATION', NULL),
    ('act_011', 1709316000000, 'manager_user', 'Shos 456', 'new_mgr', 'SHOS', 'ADD_MANAGER_TO_SHOS', 'USER'),
    ('act_012', 1709319600000, 'tag_manager', 'Tag B', 'tag2', 'DYNAMIC_TAG', 'ADD_VALUE_TO_USER', 'USER'),
