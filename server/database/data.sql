...
INSERT INTO history.records (action_id, updated_time, executor, executor_name, target, target_name, resource, resource_name, executor_type, target_type, midur_action, resource_type) VALUES
    ...
    ('act_004', 1709290800000, 'manager_user', 'יוסף הצדיק', 'Tag A', 'תגית אבטחה', NULL, NULL, 'USER', 'DYNAMIC_TAG', 'DYNAMIC_TAG_EDIT', NULL),
    ('act_005', 1709294400000, 'admin_user', 'אברהם אבינו', 'All Users Group', 'קבוצת כל המשתמשים', NULL, NULL, 'USER', 'DISTRIBUTION_GROUP', 'DISTRIBUTION_GROUP_CREATION', NULL),
    ('act_006', 1709298000000, 'super_admin', 'שלמה המלך', 'jane.smith', 'ג''יין סמית''', NULL, NULL, 'USER', 'USER', 'USER_DELETION', NULL),
    ('act_007', 1709301600000, 'group_admin', 'דוד המלך', 'Distribution List A', 'רשימת תפוצה א''', 'john.doe', 'ג''ון דו', 'USER', 'DISTRIBUTION_GROUP', 'ADD_USER_TO_DISTRIBUTION_GROUP', 'USER'),
    ('act_008', 1709305200000, 'admin_user', 'אברהם אבינו', 'Admin Profile', 'פרופיל מנהל מערכת', NULL, NULL, 'USER', 'PROFILE', 'PROFILE_CREATION', NULL),
    ('act_009', 1709308800000, 'sys_admin', 'יצחק אבינו', 'Legacy System', 'מערכת מורשת', NULL, NULL, 'USER', 'END_SYSTEM', 'END_SYSTEM_DELETION', NULL),
    ('act_010', 1709312400000, 'auto_bot', 'בוט סנכרון', 'Entity 999', 'ישות 999', NULL, NULL, 'USER', 'ENTITY', 'ENTITY_CREATION', NULL),
    ('act_011', 1709316000000, 'manager_user', 'יוסף הצדיק', 'Shos 456', 'שוס 456', 'new_mgr', 'מנהל חדש', 'USER', 'SHOS', 'ADD_MANAGER_TO_SHOS', 'USER'),
    ('act_012', 1709319600000, 'tag_manager', 'מרדכי היהודי', 'Tag B', 'תגית ב''', 'tag2', 'תג דינמי 2', 'USER', 'DYNAMIC_TAG', 'ADD_VALUE_TO_USER', 'USER'),
    ('act_013', 1709323200000, 'config_bot', 'בוט הגדרות', 'john.doe', 'ג''ון דו', 'new_config', 'הגדרת מערכת חדשה', 'USER', 'USER', 'ADD_VALUE_TO_USER', NULL),
    ('act_014', 1709326800000, 'admin_user', 'אברהם אבינו', 'Profile X', 'פרופיל איקס', 'user_b', 'משתמש ב''', 'USER', 'PROFILE', 'ADD_USER_TO_PROFILE', 'USER'),
    ('act_015', 1709330400000, 'sync_service', 'שירות סנכרון', 'jane.doe', 'ג''יין דו', NULL, NULL, 'USER', 'USER', 'USER_SYNC', NULL);
